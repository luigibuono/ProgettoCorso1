...
<body>
	<div class=""
		style="height: 100vh; background-image: url('sfondo2.jpg'); background-size: cover;">
    ...
    if (course != null) {
%>
				<form action="editurl?id=<%= course.getId() %>" method="post">
					<table align="center">
						<tr>
							<td>Course Name</td>
							<td><input type="text" name="courseName"
								value="<%= course.getCourseName() %>"></td>
						</tr>
						<tr>
							<td>Course Edition</td>
							<td><input type="text" name="courseDuration"
								value="<%= course.getCourseDuration() %>"></td>
						</tr>
						<tr>
							<td>Course Price</td>
							<td><input type="text" name="coursePrice"
								value="<%= course.getCoursePrice() %>"></td>
						</tr>
						<tr>
